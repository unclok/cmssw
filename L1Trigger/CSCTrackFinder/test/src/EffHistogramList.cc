...
//////////////////
    ...
    OverallhistsQ1.push_back(EffTFPt10OverallQ1);
    OverallhistsQ1.push_back(EffTFPt12OverallQ1);
    OverallhistsQ1.push_back(EffTFPt16OverallQ1);
    ...
    OverallhistsQ2.push_back(EffTFPt10OverallQ2);
    OverallhistsQ2.push_back(EffTFPt12OverallQ2);
    OverallhistsQ2.push_back(EffTFPt16OverallQ2);
    ...
    OverallhistsQ3.push_back(EffTFPt10OverallQ3);
    OverallhistsQ3.push_back(EffTFPt12OverallQ3);
    OverallhistsQ3.push_back(EffTFPt16OverallQ3);
    ...
    CSCOnlyhistsQ1.push_back(EffTFPt10CSCOnlyQ1);
    CSCOnlyhistsQ1.push_back(EffTFPt12CSCOnlyQ1);
    CSCOnlyhistsQ1.push_back(EffTFPt16CSCOnlyQ1);
    ...
    CSCOnlyhistsQ2.push_back(EffTFPt10CSCOnlyQ2);
    CSCOnlyhistsQ2.push_back(EffTFPt12CSCOnlyQ2);
    CSCOnlyhistsQ2.push_back(EffTFPt16CSCOnlyQ2);
    ...
    CSCOnlyhistsQ3.push_back(EffTFPt10CSCOnlyQ3);
    CSCOnlyhistsQ3.push_back(EffTFPt12CSCOnlyQ3);
    CSCOnlyhistsQ3.push_back(EffTFPt16CSCOnlyQ3);
    ...
    GEMhists.push_back(EffTFPt10GEM);
    GEMhists.push_back(EffTFPt12GEM);
    GEMhists.push_back(EffTFPt16GEM);
    ...
    GEMhistsQ1.push_back(EffTFPt10GEMQ1);
    GEMhistsQ1.push_back(EffTFPt12GEMQ1);
    GEMhistsQ1.push_back(EffTFPt16GEMQ1);
    ...
    GEMhistsQ2.push_back(EffTFPt10GEMQ2);
    GEMhistsQ2.push_back(EffTFPt12GEMQ2);
    GEMhistsQ2.push_back(EffTFPt16GEMQ2);
    ...
    GEMhistsQ3.push_back(EffTFPt10GEMQ3);
    GEMhistsQ3.push_back(EffTFPt12GEMQ3);
    GEMhistsQ3.push_back(EffTFPt16GEMQ3);
    ...
    CSCRestrictedhistsQ1.push_back(EffTFPt10CSCRestrictedQ1);
    CSCRestrictedhistsQ1.push_back(EffTFPt12CSCRestrictedQ1);
    CSCRestrictedhistsQ1.push_back(EffTFPt16CSCRestrictedQ1);
    ...
    CSCRestrictedhistsQ2.push_back(EffTFPt10CSCRestrictedQ2);
    CSCRestrictedhistsQ2.push_back(EffTFPt12CSCRestrictedQ2);
    CSCRestrictedhistsQ2.push_back(EffTFPt16CSCRestrictedQ2);
    ...
    CSCRestrictedhistsQ3.push_back(EffTFPt10CSCRestrictedQ3);
    CSCRestrictedhistsQ3.push_back(EffTFPt12CSCRestrictedQ3);
    CSCRestrictedhistsQ3.push_back(EffTFPt16CSCRestrictedQ3);
    ...
    DTOnlyhistsQ1.push_back(EffTFPt10DTOnlyQ1);
    DTOnlyhistsQ1.push_back(EffTFPt12DTOnlyQ1);
    DTOnlyhistsQ1.push_back(EffTFPt16DTOnlyQ1);
    ...
    DTOnlyhistsQ2.push_back(EffTFPt10DTOnlyQ2);
    DTOnlyhistsQ2.push_back(EffTFPt12DTOnlyQ2);
    DTOnlyhistsQ2.push_back(EffTFPt16DTOnlyQ2);
    ...
    DTOnlyhistsQ3.push_back(EffTFPt10DTOnlyQ3);
    DTOnlyhistsQ3.push_back(EffTFPt12DTOnlyQ3);
    DTOnlyhistsQ3.push_back(EffTFPt16DTOnlyQ3);
    ...
    OverlaphistsQ1.push_back(EffTFPt10OverlapQ1);
    OverlaphistsQ1.push_back(EffTFPt12OverlapQ1);
    OverlaphistsQ1.push_back(EffTFPt16OverlapQ1);
    ...
    OverlaphistsQ2.push_back(EffTFPt10OverlapQ2);
    OverlaphistsQ2.push_back(EffTFPt12OverlapQ2);
    OverlaphistsQ2.push_back(EffTFPt16OverlapQ2);
    ...
    OverlaphistsQ3.push_back(EffTFPt10OverlapQ3);
    OverlaphistsQ3.push_back(EffTFPt12OverlapQ3);
    OverlaphistsQ3.push_back(EffTFPt16OverlapQ3);
    ...
    HighEtahistsQ1.push_back(EffTFPt10HighEtaQ1);
    HighEtahistsQ1.push_back(EffTFPt12HighEtaQ1);
    HighEtahistsQ1.push_back(EffTFPt16HighEtaQ1);
    ...
    HighEtahistsQ2.push_back(EffTFPt10HighEtaQ2);
    HighEtahistsQ2.push_back(EffTFPt12HighEtaQ2);
    HighEtahistsQ2.push_back(EffTFPt16HighEtaQ2);
    ...
    HighEtahistsQ3.push_back(EffTFPt10HighEtaQ3);
    HighEtahistsQ3.push_back(EffTFPt12HighEtaQ3);
    HighEtahistsQ3.push_back(EffTFPt16HighEtaQ3);
